/// File:        PeriodicTaskFactory.cs
/// Assigment:   Assignment #2 - Yoyo
/// Class:       Business Intelligence
/// Programmer:  Harley Boss
/// Date:        September 28th 2019
/// Description: A class used to create timer based tasks for updating the UI 
///              Sourced from: https://stackoverflow.com/questions/4890915/is-there-a-task-based-replacement-for-system-threading-timer
...
namespace A1_Yoyo {
    ...
    class PeriodicTaskFactory {
        ...
        public static void CancelTask(Task task, CancellationToken cancellationToken) {
            if (task != null) {
